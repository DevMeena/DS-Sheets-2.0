  ...
  return (
    <nav className='navbar navbar-expand-lg navbar-dark bg-dark'>
      <div className='container-fluid navbar-container-fluid'>
        <a className='navbar-brand' href='/lists'>
          DSA Sheets
        </a>
        <ul className='navbar-nav ms-auto mb-2 mb-lg-0'>
          <li className='nav-item dropdown' id='profileicon'>
            ...
            <ul className='dropdown-menu' aria-labelledby='navbarDropdown'>
              <li onClick={resetProgress} className='dropdown-item'>
                Reset progress
              </li>
              {/* <li><a className="dropdown-item" href="/change-password">Change password</a></li> */}
              {isAdmin == 1 && (
                <li className='dropdown-item' onClick={adminPanel}>
                  Admin dashboard
                </li>
              )}
              {isAdmin == 1 ? (
                <li>
                  <a className='dropdown-item' onClick={Forums}>
                    Forums
                  </a>
                </li>
              ) : (
                <li>
                  <a className='dropdown-item' onClick={Feedback}>
                    Feedback
                  </a>
                </li>
              )}
